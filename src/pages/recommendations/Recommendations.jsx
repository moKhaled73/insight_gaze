...
const Recommendations = () => {
  ...
  return (
    <div className="container">
      ...
      <div className="box-recom">
        <div className="rules">
          <h2>Guidelines</h2>
          <ul className="guideline">
            <li onClick={() => setActiveRule("con1")} className="active">
              Human Interface Guidelines (HIG)
            </li>
            <li onClick={() => setActiveRule("con2")}>
              Material Design Guidelines
            </li>
            <li onClick={() => setActiveRule("con3")}> Fluent Design System</li>
            <li onClick={() => setActiveRule("con4")}>
              Accessibility Guidelines
            </li>
            <li onClick={() => setActiveRule("con5")}>
              Platform-Specific Guidelines
            </li>
            <li onClick={() => setActiveRule("con6")}>
              Nielsen’s 10 Heuristic Principles
            </li>
            <li onClick={() => setActiveRule("con7")}>Norman’s 7 Principles</li>
          </ul>
            ...
            {activeRule === "con1" ? (
              <div id="con1" className="content">
                ...
                <p>
                  ...
                  Exercitationem quas eum impedit porro delectus, odio placeat?
                  Recusandae itaque eligendi fugit?
                </p>
              ...
              <div id="con2" className="content">
                <p>
                  ...
                  <br />
                  <span> Responsive Design</span> : Designs adapt to all screen
                  sizes and platforms.
                  <br />
              ...
              <div id="con4" className="content">
                <p>
                  ...
                  <br />
                  <span>Operable </span>: Ensure easy navigation using multiple
                  input methods.
                  <br />
              ...
              <div id="con5" className="content">
                <p>
                  ...
                  <br />
                  <span>iOS (HIG) </span> : Follow iOS navigation patterns, such
                  as the back button and gestures.
                  <br />
              ...
              <div id="con6" className="content">
                <p>
                  <span>System Status Visibility </span>: Keep users informed of
                  ongoing processes.
                  <br />
                  ...
                  before they occur.
                  <br />
                  <span>Recognition Over Recall </span> : Reduce memory load by
                  showing options.
                  <br />
              ...
              <div id="con7" className="content">
                <p>
                  ...
                  <span> Feedback </span>: Provide clear and immediate responses
                  to user actions.
                  <span> Constraints</span>: Guide users with limitations to
                  prevent errors.
                  <span> Mapping </span> :Ensure a logical relationship between
